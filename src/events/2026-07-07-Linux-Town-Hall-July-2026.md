---
title: Linux Town Hall July
description: Join us for the Linux Town Hall July meeting, with a recap of UN Open Source Week.
...
Join us for the Linux Town Hall July meeting for hardware, books, community discussion, and a featured talk.

<div class="card border-primary shadow-sm mb-4">
<div class="card-body">
<span class="badge bg-primary mb-2"><i class="bi bi-mic-fill me-1"></i> Featured Talk</span>
<h3 class="card-title mb-1">UN Open Source Week: A Recap</h3>
...
- The server and domain
- Linux Regional Summit (Linux Birthday, August 25)
...
From 7pm, the Town Hall proper moves to the training and learning space (the upstairs room with the computers) at Kathleen Syme Library, for community discussion points and lightning talks (always welcome, always impromptu).
...
- 19:45 Featured Talk - **UN Open Source Week: A Recap** with Alexar Pendashteh
- 20:10 Lightning talks (impromptu, all welcome)
